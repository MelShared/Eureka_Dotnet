...
namespace ServiceReference1
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference1.IMovimientoService")]
    public interface IMovimientoService
    {
        ...
        System.Threading.Tasks.Task<ServiceReference1.CustomMovimientoModel[]> ObtenerMovimientosPorCuentaAsync(string codigoCuenta);
        ...
        System.Threading.Tasks.Task RegistrarMovimientoAsync(ServiceReference1.CustomMovimientoModel movimiento);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public interface IMovimientoServiceChannel : ServiceReference1.IMovimientoService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public partial class MovimientoServiceClient : System.ServiceModel.ClientBase<ServiceReference1.IMovimientoService>, ServiceReference1.IMovimientoService
    {
        ...
        public System.Threading.Tasks.Task<ServiceReference1.CustomMovimientoModel[]> ObtenerMovimientosPorCuentaAsync(string codigoCuenta)
        {
            return base.Channel.ObtenerMovimientosPorCuentaAsync(codigoCuenta);
        }
        
        public System.Threading.Tasks.Task RegistrarMovimientoAsync(ServiceReference1.CustomMovimientoModel movimiento)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IMovimientoService))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:57064/MovimientoService.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
