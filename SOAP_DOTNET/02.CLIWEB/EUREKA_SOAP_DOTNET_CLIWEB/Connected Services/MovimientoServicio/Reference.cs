...
namespace EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="MovimientoServicio.IMovimientoService")]
    public interface IMovimientoService {
        ...
        EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.CustomMovimientoModel[] ObtenerMovimientosPorCuenta(string codigoCuenta);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMovimientoService/ObtenerMovimientosPorCuenta", ReplyAction="http://tempuri.org/IMovimientoService/ObtenerMovimientosPorCuentaResponse")]
        System.Threading.Tasks.Task<EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.CustomMovimientoModel[]> ObtenerMovimientosPorCuentaAsync(string codigoCuenta);
        ...
        void RegistrarMovimiento(EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.CustomMovimientoModel movimiento);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMovimientoService/RegistrarMovimiento", ReplyAction="http://tempuri.org/IMovimientoService/RegistrarMovimientoResponse")]
        System.Threading.Tasks.Task RegistrarMovimientoAsync(EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.CustomMovimientoModel movimiento);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMovimientoServiceChannel : EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.IMovimientoService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MovimientoServiceClient : System.ServiceModel.ClientBase<EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.IMovimientoService>, EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.IMovimientoService {
        ...
        public EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.CustomMovimientoModel[] ObtenerMovimientosPorCuenta(string codigoCuenta) {
            return base.Channel.ObtenerMovimientosPorCuenta(codigoCuenta);
        }
        
        public System.Threading.Tasks.Task<EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.CustomMovimientoModel[]> ObtenerMovimientosPorCuentaAsync(string codigoCuenta) {
            return base.Channel.ObtenerMovimientosPorCuentaAsync(codigoCuenta);
        }
        
        public void RegistrarMovimiento(EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.CustomMovimientoModel movimiento) {
            base.Channel.RegistrarMovimiento(movimiento);
        }
        
        public System.Threading.Tasks.Task RegistrarMovimientoAsync(EUREKA_SOAP_DOTNET_CLIWEB.MovimientoServicio.CustomMovimientoModel movimiento) {
